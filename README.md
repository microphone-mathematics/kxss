...
This a adaption of Emoe's adaptation of tomnomnom's kxss tool with a different output format. I didn't want to fork his whole Hacks-Repository so created my Own ;-)
...
```
go get github.com/microphone-mathematics/kxss
```
